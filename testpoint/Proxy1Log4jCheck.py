...
class Proxy1Log4jCheck(_BaseTestPoint):
    ...
    def _checkpoint(self):
        ...
        self.logger.debug("proxy-1 info log maxFileSize is %s * %s"%(proxy_info_log_size,proxy_info_log_index))
        self.logger.debug("proxy-1 trace log maxFileSize is %s * %s"%(proxy_trace_log_size, proxy_trace_log_index))
        self.logger.debug("proxy-1 error log maxFileSize is %s * %s"%(proxy_error_log_size, proxy_error_log_index))
