...
class SecurityShouldBeMatched(_BaseTestPoint):
    ...
    def _checkpoint(self):
        ...
        print "nbi3gc-proxy1 ssl support is:%s"%self._nbi3gc_proxy1_ssl_support
        print "nbi3gc-proxy2 ssl support is:%s"%self._nbi3gc_proxy2_ssl_support
        print "nbi3gc-proxy3 ssl support is:%s"%self._nbi3gc_proxy3_ssl_support
        print "nbi3gcom ssl support is:%s"%self._nbi3gcom_ssl_support
