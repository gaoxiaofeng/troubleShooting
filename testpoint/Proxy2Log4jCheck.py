...
class Proxy2Log4jCheck(_BaseTestPoint):
    ...
    def _checkpoint(self):
        ...
        if proxy_info_log_maxSize > conversion("50MB"):
            ...
            self.logger.error("Proxy-2 info logs maxFileSize over limit, maxFileSize is: %s * %s > 50MB" % (proxy_info_log_size, proxy_info_log_index))
        ...
        if proxy_error_log_maxSize > conversion("50MB"):
            ...
            self.logger.error("Proxy-2 error logs maxFileSize over limit, maxFileSize is: %s * %s > 50MB" % (proxy_error_log_size, proxy_error_log_index))
