...
class Proxy3Log4jCheck(_BaseTestPoint):
    ...
    def _checkpoint(self):
        ...
        print "proxy-3 info log maxFileSize is %s * %s"%(proxy_info_log_size,proxy_info_log_index)
        print "proxy-3 trace log maxFileSize is %s * %s"%(proxy_trace_log_size, proxy_trace_log_index)
        print "proxy-3 error log maxFileSize is %s * %s"%(proxy_error_log_size, proxy_error_log_index)
